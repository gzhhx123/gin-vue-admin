  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="品牌简称" prop="brandShortName">
         <el-input v-model="searchInfo.brandShortName" placeholder="搜索条件" />
        </el-form-item>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="bagique_Brand" />
            <ExportExcel  template-id="bagique_Brand" />
            <ImportExcel  template-id="bagique_Brand" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="品牌简称:"  prop="brandShortName" >
              <el-input v-model="formData.brandShortName" :clearable="true"  placeholder="请输入品牌简称" />
            </el-form-item>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="品牌名称">
                        {{ detailFrom.brandName }}
                    </el-descriptions-item>
                    <el-descriptions-item label="品牌简称">
